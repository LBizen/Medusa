...
<div class="row">
    <div id="container-display-show-header" class="container-display-show-table col-lg-12">
    ...
    <div class="row">
    <div class="col-lg-12">
    <div id="container-display-show-checkbox-controls" class="container-display-show-table">
    ...
    % else:
        &nbsp;
    % endif
    </div> <!-- end of container-display-show-table -->
    </div> <!-- /col-lg-12 -->
</div> <!-- end of row -->
<div>&nbsp;</div>
